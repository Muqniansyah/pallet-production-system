    ...
    <div class="relative min-h-screen overflow-hidden flex items-center justify-center bg-[#1E0F05]">
        ...
        <div class="relative z-10 w-full max-w-sm mx-auto px-4 py-10">
            ...
            <div class="flex flex-col items-center mb-7">
                ...
                <h2 class="text-2xl font-extrabold text-[#FDF0E0] tracking-tight">Reset Password</h2>
                <p class="text-sm text-[#A07850] mt-1.5 text-center max-w-xs">Buat password baru untuk akun SIPALET kamu.</p>
            </div>
