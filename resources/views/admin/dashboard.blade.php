            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <span class="text-[8px] font-black text-slate-300 uppercase tracking-widest">Output</span>
                    </div>
                    <h3 class="text-slate-500 text-[9px] font-black uppercase tracking-wider">Total Produksi</h3>
                    <p class="text-2xl font-black text-slate-800 tracking-tighter">1,200</p>
                </div>
                ...
                <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <span class="text-[8px] font-black text-slate-300 uppercase tracking-widest">Stock</span>
                    </div>
                    <h3 class="text-slate-500 text-[9px] font-black uppercase tracking-wider">Stok Pallet</h3>
                    <p class="text-2xl font-black text-slate-800 tracking-tighter">530</p>
                </div>
                ...
                <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                    ...
                    <p class="text-2xl font-black text-slate-800 tracking-tighter">25</p>
                </div>
            </div>
