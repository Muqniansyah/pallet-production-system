            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <span class="text-[10px] font-black text-slate-300 uppercase italic">Pengajuan</span>
                    </div>
                    <h3 class="text-slate-500 text-[10px] font-black uppercase tracking-widest">Total Pengajuan</h3>
                    <p class="text-3xl font-black text-slate-800 mt-1">{{ number_format($totalRequests) }}</p>
                </div>

                <!-- card client aktif -->
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                    <div class="flex justify-between items-start mb-4">
                        <div class="bg-rose-50 p-3 rounded-xl group-hover:bg-rose-600 transition-colors">
                            <svg class="w-5 h-5 text-rose-600 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-slate-500 text-[10px] font-black uppercase tracking-widest">Client Aktif</h3>
                    <p class="text-3xl font-black text-slate-800 mt-1">{{ number_format($activeClients) }}</p>
                </div>
            </div>
