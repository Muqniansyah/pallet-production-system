<x-app-layout>
    <div class="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <!-- kontainer form meet & riwayat meet -->
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <form method="POST" action="/client/meeting-request" class="space-y-4">
                        ...
                        <button
                            ...
                            class="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-black py-4 px-4 rounded-2xl shadow-lg shadow-emerald-200 transition-all active:scale-95 uppercase tracking-widest text-sm">
                            Ajukan Pertemuan
                        </button>
                    </form>
                </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-blue-50/50 transition-colors">
                                    ...
                                    <!-- keterangan jika status ditolak -->
    ...
    <script>
        // Pagination AJAX tanpa refresh halaman untuk tabel meeting
